    ...
    'metadata.value'(value) {
      if (!this.metadata.inTable) {
        ...
        if (this.metadata.displayed) {
          if (!this.options.some(option => option.key === value) && !this.isEmptyValue(this.metadata.displayColumn)) {
            this.options.push({
              key: value,
        ...
        this.value = value
        if (this.metadata.displayed && this.metadata.optionCRUD !== 'create-new' && !this.findLabel(value) && this.isEmptyValue(this.metadata.displayColumn)) {
          this.value = undefined
        }
      }
    },
